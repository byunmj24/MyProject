...
<div id="wrap">
	...
	<!-- 콘텐츠 영역 -->
	<div id="contents_sub">
		<h1 style="font-size: 30px; color: #000; margin-bottom: 20px;">판매 상품 수정하기</h1>
		<div class="bbs_area" id="bbs">
			<form action="shopEdit" method="post" encType="multipart/form-data">
		<%--
